...
class MergeEnv(AbstractEnv):
    ...
    def default_config(cls) -> dict:
        ...
        cfg.update({
            "collision_reward": 20,
            "right_lane_reward": 0.1, # default 
            "high_speed_reward": 0.4,
            "merging_speed_reward": -0.5, #default
    ...
    def _reward(self, action: int) -> float:
        ...
        reward = self.config["collision_reward"] * self.vehicle.crashed \
            ...
            + self.config["high_speed_reward"] * ( self.vehicle.speed - 20 ) / (30-20)

        #### THIS IS THE PART TO CHANGE ##########################################################
        #  rewards['high_speed"] = np.clip(forward_speed, 0, 1)
